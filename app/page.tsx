...
export default function Home() {
  const lessons = [
    ...
    },
    {
      ...
      description: "Learn how Claude Code reads your codebase and makes precise edits.",
      status: "coming-soon",
    },
    {
      number: 4,
      title: "Running Commands",
      description: "Use Claude Code to run terminal commands on your behalf.",
      status: "coming-soon",
    },
    {
      number: 5,
      title: "Debugging with Claude",
      description: "Walk through a broken program and fix it together with Claude Code.",
      status: "coming-soon",
    },
  ];
